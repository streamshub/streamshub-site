...
linkTitle = "Community"
description = "Want to get involved with the StreamsHub console? Check out the options here for how to get started."
layout = "single"
bookHidden = true
+++
...
- {{< card href="https://github.com/streamshub" class="project-card inline-header-card" >}}
  ...
  [Go to GitHub](https://github.com/streamshub)
  {{< /card >}}
{{% /columns %}}
</section>
